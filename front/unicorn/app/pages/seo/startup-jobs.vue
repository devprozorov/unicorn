...
const content = computed(() => dict.value.seoLanding.startupJobs)
...
useHead(() => ({
  ...
  meta: [
    ...
    { property: 'og:url', content: 'https://unicornstar.online/seo/startup-jobs' },
  ...
  link: [
    { rel: 'canonical', href: 'https://unicornstar.online/seo/startup-jobs' }
  ],
  script: [
    {
      ...
      children: JSON.stringify({
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://unicornstar.online/seo/startup-jobs'
          }
        ]
      })
    }
